      ...
      <MegaMenus>
        {megaMenus.map((menu, index) => (
          ...
          >
            ...
            {menu.isSeparator ? (
              <Separator>|</Separator> // Render the separator
            ) : (
...
const Separator = styled.span`
  ...
  color: #333;
  font-weight: normal;
  cursor: default; // Disable pointer events for the separator
`;
const EditButton = styled.div`
  ...
  color: #fff;
  text-decoration: none;
  background-color: #a9252b; // Light background
  border-radius: 4px;
