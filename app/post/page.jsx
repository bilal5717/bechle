...
import CategorySelector from './PostSubCategories/subCategories';
...
const CATEGORIES = [
  ...
  { id: 12, name: 'Furniture & Home Decor', icon: '🛋️', component: 'FasionNBeauty' },
  { id: 13, name: 'Fashion & Beauty', icon: '👗', component: 'FasionNBeauty' },
                      ...
                      <div className="card-body d-flex align-items-center p-3">
                        <div className="d-flex align-items-center w-100">
                          <div className="bg-light rounded-circle d-flex align-items-center justify-content-center"
                            style={{ width: '60px', height: '60px', minWidth: '60px', marginRight: '12px' }}>
                            <span className="fs-4">{category.icon}</span>
                          </div>
                          <div className="text-start flex-grow-1">
                            <h6 className="mb-0 fw-bold" style={{
                              fontSize: '14px', color: '#212121', lineHeight: '1.4'
                            }}>
                              {category.name}
                            </h6>
                          </div>
