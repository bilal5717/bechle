...
export default function PostPage() {
  ...
  return (
    <div className="container-fluid body-wrapper my-0 product-details-wrapper">
      ...
      {/* lesft Side post /product details  */}
<div className="row flex-nowrap">
            ...
            <div className="col-12 border rounded-3 my-3 p-0">
              <div className=" p-3 border border-gray-200 rounded-lg shadow-md bg-white">
                  ...
                  <div className="flex items-center  text-gray-500">
                    <img src="https://cdn-icons-png.flaticon.com/512/535/535239.png" width="16" alt="Location" className="mr-2" />
            ...
            <button className="btn d-flex align-items-center justify-content-center  w-50 mx-2 border-dark">
              <LuShieldCheck className="mx-2" size={25} color="#a92824"/> {/* Increased size */}
            ...
            <button className="btn d-flex align-items-center justify-content-center border-dark w-50 product-info-btn">
              <LuArchiveRestore className="mx-2" size={25} color="#a92824"/> {/* Increased size */}
              <b>Easy Return</b>
            </button>
          </div>
          ...
          <h6 className="text-xl font-semibold mb-2"><b>Ad Description</b></h6>
            <p className="text-dark py-2">The product was purchased from Hepsiburada seller in January 2024. It has an invoice. It is still under warranty and has more than 11 months to charge. It is the 256 gb model. The battery is 87%. There is no problem with the phone. It has never been used without unbreakable glass and a case. The unbreakable glass and 3 cases will be given to the buyer together with its box. I am selling it because I upgraded.</p>
          </div>
